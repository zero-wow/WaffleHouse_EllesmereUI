...
local function GetSettings()
    ...
    if WaffleHouseDB.flightIndicatorCastProgress == nil then
        WaffleHouseDB.flightIndicatorCastProgress = true
    end
