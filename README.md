...
- Vignette Radar only projects live minimap vignettes and coordinates exposed by Blizzard; its compact 150-yard launcher, category legend, and specific-vignette focus do not scan for hidden locations or ship a rare database.
